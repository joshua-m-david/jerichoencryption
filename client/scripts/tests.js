...
$(document).ready(function()
{
	...
	QUnit.test("Test if HTML5 Local Storage is supported in this browser", function(assert)
	{
	...
	QUnit.test("Test if HTML5 Web Workers are supported in this browser", function(assert)
	{
	...
	QUnit.test("Test if HTML5 Web Crypto API is supported in this browser", function(assert)
	{
	...
	QUnit.test("Test if HTML5 Offline Web Application Cache is supported in this browser", function(assert)
	{
		assert.ok(offlineWebApplicationCacheSupported === true);
	});
	...
	QUnit.test("Test left padding of numbers to certain length", function(assert)
	{
	...
	QUnit.test("Test conversion of small integer to hexadecimal", function(assert)
	{
	...
	QUnit.test("Test conversion of large integer to hexadecimal", function(assert)
	{
	...
	QUnit.test("Get random bits from the Web Crypto API and XOR it with Salsa20 keystream", function(assert)
	{
	...
	/*
	 * ---------------------------------------------------------------------------------
	 * Convert text with UTF-8 special characters to binary and back again to UTF-8 text
	 * ---------------------------------------------------------------------------------
	 */
	...
	QUnit.test("Convert text with UTF-8 special characters to binary and back again to UTF-8 text", function(assert)
	{
	...
	QUnit.test("Pad the message with random bits up to the maximum message size", function(assert)
	{
	...
	QUnit.test("Test padding function on max length plaintext", function(assert)
	{
	...
	QUnit.test("Test padding function on oversize length plaintext", function(assert)
	{
	...
	QUnit.test("Get the current timestamp in UTC and test conversion to binary", function(assert)
	{
	...
	QUnit.test("Convert the binary timestamp back to an integer then a date", function(assert)
	{
	...
	QUnit.test("Convert the max length plaintext to binary", function(assert)
	{
	...
	QUnit.test("Get a random MAC algorithm depending on the last byte of the pad", function(assert)
	{
	...
	QUnit.test("Prepare message for encryption", function(assert)
	{
	...
	QUnit.test("Reverse message parts or not depending on second last byte of pad", function(assert)
	{
	...
	QUnit.test("Convert one-time pad from hexadecimal to binary", function(assert)
	{
	...
	QUnit.test("Get the pad identifier from pad in binary", function(assert)
	{
	...
	QUnit.test("Get one-time pad message parts in binary", function(assert)
	{
	...
	QUnit.test("Encrypt the message parts with the pad message parts", function(assert)
	{
	...
	QUnit.test("XOR two hexadecimal strings together", function(assert)
	{
	...
	QUnit.test("Combine pad identifier and the ciphertext message parts", function(assert)
	{
	...
	QUnit.test("Convert the complete ciphertext binary to hexadecimal", function(assert)
	{
	...
	QUnit.test("Test hashing with Keccak 512 bit", function(assert)
	{
	...
	QUnit.test("Test hashing with Skein 512 bit", function(assert)
	{
	...
	QUnit.test("Test creation of MAC for chat program", function(assert)
	{
	...
	QUnit.test("Get MAC part of the one-time pad to use for encrypting the MAC", function(assert)
	{
	...
	QUnit.test("Encrypt the MAC with one-time pad", function(assert)
	{
	...
	QUnit.test("Convert the ciphertext hexadecimal back to binary", function(assert)
	{
	...
	QUnit.test("Get message ciphertext parts from ciphertext", function(assert)
	{
	...
	QUnit.test("Decrypt ciphertext message parts to plaintext message parts binary", function(assert)
	{
	...
	QUnit.test("Reverse binary plaintext message parts back to original order", function(assert)
	{
	...
	QUnit.test("Split up ASCII plaintext message parts", function(assert)
	{
	...
	QUnit.test("Get plaintext message without padding", function(assert)
	{
	...
	QUnit.test("Basic encryption and decryption of all possible ASCII characters", function(assert)
	{
		assert.ok(asciiPlaintext === common.allPossibleChars.join(''), asciiPlaintext);
	});
	...
	QUnit.test("Encrypt message to be ready for transport using random padding and random MAC", function(assert)
	{
	...
	QUnit.test("Get the encrypted MAC from the end of the ciphertext", function(assert)
	{
	...
	QUnit.test("Decrypt the MAC", function(assert)
	{
	...
	QUnit.test("Get just the ciphertext without the ciphertext MAC", function(assert)
	{
	...
	QUnit.test("Test verification of MAC", function(assert)
	{
	...
	QUnit.test("Get the pad identifier from the ciphertext", function(assert)
	{
	...
	QUnit.test("Decrypt and verify message using random padding and random MAC with wrapper method", function(assert)
	{
	...
	QUnit.test("Fix the server URL for excess forward slashes", function(assert)
	{
	...
	QUnit.test("Test HTML output escaping for XSS", function(assert)
	{
	...
	QUnit.test("Test escaping of message for XSS and linkifying", function(assert)
	{
	...
	QUnit.test("Test MAC of server request", function(assert)
	{
		// Check lengths equals 128 hexadecimal chars (512 bits)
		assert.ok(requestMacLength === 128, requestMacLength);
		assert.ok(requestMac === 'a4c495213131b3cb8c9240f9017c98be3e99b99b2cb88702e7b093e2b58be0699515ae7f6111f6903225d21e6fc547f6e75981a07c8f059ae560c9efbe36a7ca', requestMac);
	});
	...
	QUnit.test("Test MAC response validation", function(assert)
	{
		assert.ok(validResponse === true, validResponse);
	});
	...
	QUnit.test("Test getting pad from local database to decrypt message", function(assert)
	{
	...
	QUnit.test("Test deleting received and verified messages", function(assert)
	{
	...
	QUnit.test("Sort decrypted messages by earliest sent timestamp", function(assert)
	{
	...
	QUnit.test("Test removal of pad identifier and returning the remaining pad", function(assert)
	{
	...
	QUnit.test("Test AES-CTR 256 bit encryption against published test vectors", function(assert)
	{
	...
	QUnit.test("Test AES-CTR keystream generation", function(assert)
	{
	...
	QUnit.test("Test Salsa20 256 bit keystream generation", function(assert)
	{
	...
	QUnit.test("Test database cascade stream cipher encryption", function(assert)
	{
	...
	QUnit.test("Test database cascade MAC using Skein and Keccak", function(assert)
	{
	...
	QUnit.test("Test database row level cascade encrypt and MAC", function(assert)
	{
	...
	QUnit.test("Test database row level cascade verify MAC and decrypt", function(assert)
	{
	 ...
	 * Add <script src="scripts/libraries/cryptojs-sha1.js"></script> to run in tests.html
	 * ------------------------------------------------------------------
	 */
	...
	*/
	...
	QUnit.test("Test Keccak PBKDF with 100 iterations", function(assert)
	{
	...
	QUnit.test("Test Skein PBKDF with 100 iterations", function(assert)
	{
	...
	QUnit.test("Test Cascade PBKDF with PBKDF2-Keccak and Skein PBKDF with 100 iterations each", function(assert)
	{
	...
	QUnit.test("Derive keys from master key", function(assert)
	{
	...
	QUnit.test("Encrypt and MAC the database keys with the derived keys", function(assert)
	{
	...
	QUnit.test("Verify the MAC of the encrypted database keys", function(assert)
	{
	...
	QUnit.test("Test creation of database keys and failsafe keys using the random data from the TRNG", function(assert)
	{
	...
	QUnit.test("Create pads and test correct allocation between users", function(assert)
	{
	...
	QUnit.test("Test encryption and authentication of one-time pads", function(assert)
	{
	...
	QUnit.test("Test MAC creation and verification of a user's pad database index", function(assert)
	{
		// Create the MAC
	...
	QUnit.test("Test creation of a MAC of the database indexes for all users", function(assert)
	{
		var keccakMacKey = 'e4096eaeadb01cb4a0f274d59da537a66ff4907b7db7b3e0a235581f64b2560eeb129b0f2870a08fe7953e354962a579a5634668e4caae98335fe3379d4bb791';
		var skeinMacKey = 'd6dff9b318515ff04134389ec3da7460f6927e321092c49e3a54d761d57b3d38eae1c0cc2af8aacb8169c9d682bb01a2c8788a5a489baaefd7f7841c80295c9c';
	...
	QUnit.test("Verify MAC of all user's pad database indexes", function(assert)
	{
	...
	QUnit.test("Test random numbers between minimum and maximum are in correct range", function(assert)
	{
		// Test small maximums
	...
	QUnit.test("Calculate passphrase strength in bits", function(assert)
	{
