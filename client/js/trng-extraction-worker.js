...
{		
	// Run the Von Nuemann Extractor on the processed data and send it back to the main thread
	self.postMessage({
		'fullBinaryDataExtracted': common.vonNeumannExtractor(e.data.fullBinaryDataProcessed)
	});
